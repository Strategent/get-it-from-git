...
export function AppSidebar() {
  ...
  const renderGroup = (
    ...
    <SidebarGroup>
      {!collapsed && (
        <SidebarGroupLabel className="font-serif-display text-[11px] tracking-[0.04em] text-muted-foreground/70 px-3" style={{ fontFamily: '"Instrument Serif", Georgia, serif' }}>
          {label}
        </SidebarGroupLabel>
      )}
      <SidebarGroupContent>
        ...
        <div className="flex items-center gap-2.5">
          ...
          {!collapsed && (
            <div className="min-w-0">
              ...
              <div className="font-serif-display text-[10.5px] uppercase tracking-[0.04em] text-muted-foreground truncate" style={{ fontFamily: '"Radley", Georgia, serif' }}>
                Partner
              </div>
            </div>
          )}
