    ...
    render: () => (
      <div className="flex h-full flex-col">
        ...
        <div className="flex-1">
          ...
          <News src="WSJ" hed="Wealth managers face tighter fiduciary disclosure rules in Q3" body="SEC guidance takes effect Oct 1. Review IPS docs before deadline." />
        ...
        <div className="mt-4 pt-3 border-t border-[#f0f0f0] text-[10px] text-neutral-300 tracking-wide">
          Generated by Syra · Harwick &amp; Sterne · Confidential · Sep 7, 2026
        </div>
      </div>
    ),
  },
