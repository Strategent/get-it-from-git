...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      { rel: "preload", as: "image", type: "image/webp", fetchPriority: "high", href: "/john-harwick.webp" },
      { rel: "preload", as: "image", type: "image/webp", fetchPriority: "high", href: "/email-elena-smith.webp" },
      { rel: "preload", as: "image", type: "image/webp", fetchPriority: "high", href: "/email-emma-reeves.webp" },
      { rel: "preload", as: "image", type: "image/webp", fetchPriority: "high", href: "/email-adrian-engman.webp" },
      { rel: "preload", as: "image", type: "image/webp", fetchPriority: "high", href: "/email-claire-bennett.webp" },
      { rel: "preload", as: "image", type: "image/webp", fetchPriority: "high", href: "/email-daniel-brooks.webp" },
      { rel: "preload", as: "image", type: "image/webp", fetchPriority: "high", href: "/email-lena-foster.webp" },
      { rel: "preload", as: "image", type: "image/webp", fetchPriority: "high", href: "/email-maya-lopez.webp" },
      { rel: "preload", as: "image", type: "image/webp", fetchPriority: "high", href: "/email-nina-mercer.webp" },
      { rel: "preload", as: "image", type: "image/webp", fetchPriority: "high", href: "/email-stripe-logo.webp" },
